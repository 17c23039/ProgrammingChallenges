...
sl = str(input("What do you want to add to your shopping list? ")) #Asks for shoppuing list.
print("Thanks. Adding..")
slanswer = input("Would you like to add any more item(s) to your shopping list? Y/N/END. Please write the answer as we did. Y or N or END. ")
if slanswer == "N" :
  ...
  sleep(2.5)
  print("Okay, your shopping list consists of " + sl + " along with your add ons of " + sladd1)
  sleep(3)
  print("Thanks! Use our service again soon!")    
elif slanswer == "END" :
  print("Okay, shutting off...")
else :
  print("That is an invalid option! Re-run the code to use me again.")
